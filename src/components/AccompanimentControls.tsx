  ...
  return (
    <div className="p-4 bg-gray-700 rounded-lg shadow-md space-y-4">
      ...
      <div className="bg-gray-600 p-3 rounded-b-md rounded-r-md min-h-[200px]">
        {activeTab === 'chords' && <ChordInstrumentPanel {...props} />}
        {activeTab === 'drums' && <DrumKitPanel {...props} />}
        {activeTab === 'bass' && <BassGuitarPanel {...props} />}
        {activeTab === 'effects' && <EffectsPanel {...props} />}
      </div>
...
const ChordInstrumentPanel: React.FC<AccompanimentControlsProps> = ({ accompanimentLayers, onRemoveAccompanimentLayer, onUpdateAccompanimentLayer, onAddAccompanimentLayer, chordProgressionForCustomEditor, customRhythms, onUpdateCustomBeat }) => (
  <div className="space-y-4">
...
const DrumKitPanel: React.FC<AccompanimentControlsProps> = ({ drumsEnabled, onDrumsEnabledChange, drumVolume, onDrumVolumeChange, drumPattern, onDrumPatternChange, chordProgressionForCustomEditor, customDrumData, onUpdateCustomDrumCell }) => (
...
const BassGuitarPanel: React.FC<AccompanimentControlsProps> = ({ bassEnabled, onBassEnabledChange, bassVolume, onBassVolumeChange, bassInstrument, onBassInstrumentChange, bassPattern, onBassPatternChange }) => (
  <div className="space-y-3">
    <div className="flex items-center justify-between">
...
const EffectsPanel: React.FC<AccompanimentControlsProps> = ({ reverbLevel, onReverbLevelChange, delayLevel, onDelayLevelChange, swing, onSwingChange }) => (
  <div className="space-y-3">
