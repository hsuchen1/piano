...
import type { PluckSynthOptions, MembraneSynthOptions, NoiseSynthOptions, MetalSynthOptions, MonoSynthOptions, SynthOptions as ToneSynthOptions, OmniOscillatorOptions, EnvelopeOptions, FilterOptions, FrequencyEnvelopeOptions, NoiseType, ToneOscillatorType, EnvelopeCurve, FatOscillatorOptions, FMOscillatorOptions, PulseOscillatorOptions, AMOscillatorOptions, OscillatorOptions as ToneOscillatorOptionsBase, NoiseOptions as ToneNoiseOptions } from 'tone';
...
export const DRUM_SYNTH_CONFIGS: {
  ...
  [DrumInstrument.Snare]: {
    noise: { type: "white", playbackRate: 3 }, // fadeIn, fadeOut default to 0
  ...
  [DrumInstrument.HiHatClosed]: {
    noise: { type: "pink", playbackRate: 5 }, // fadeIn, fadeOut default to 0
...
export const BASS_SYNTH_CONFIGS: Record<BassInstrument, Partial<MonoSynthOptions>> = {
  [BassInstrument.ElectricBass]: {
    ...
    filter: { type: 'lowpass', Q: 2, frequency: 1200, rolloff: -12 as const, detune:0, gain:0 },
    volume: -6,
  },
  [BassInstrument.SynthBass]: {
    ...
    filter: { type: 'lowpass', Q: 3, frequency: 800, rolloff: -12 as const, detune: 0, gain: 0 },
    volume: -8,
  },
  [BassInstrument.AcousticBass]: {
    ...
    filter: { type: 'lowpass', Q: 1.5, frequency: 1000, rolloff: -12 as const, detune: 0, gain: 0 },
    volume: -4,
  }
};
...
export const USER_PIANO_SOUND_CONFIGS: Record<Exclude<UserPianoInstrument, UserPianoInstrument.SampledGrand>, Partial<ToneSynthOptions>> = {
  ...
  [UserPianoInstrument.SimpleSynth]: {
    oscillator: { type: 'triangle', phase: 0 }, // Changed from 'triangle8'
